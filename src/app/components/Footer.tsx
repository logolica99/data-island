...
export default function Footer() {
  return (
    <div className="bg-[#131418] ">
      <div className="m-auto flex w-[90%] flex-col px-8 py-12 font-akrobat md:w-[80%] lg:flex-row   lg:justify-between  gap-6 ">
        <div className="">
          <div className="flex  items-center gap-2  border-b-2 pb-3 md:w-[250px] ">
          ...
          <div className="mt-6 flex gap-6">
            <Link
              className="text-xl text-white transition duration-150 ease-in-out hover:opacity-80"
              href={""}
            >
              <GrFacebookOption />
            </Link>
        ...
        <div className="text-white">
          <h3 className="my-2 text-3xl font-bold">ABOUT</h3>
          <Link href={""} className="block text-xl text-[#898fa4] ">
            Our Story
          </Link>
          <Link href={""} className="block text-xl text-[#898fa4]">
            Team
        ...
        <div className="text-white">
          <h3 className="my-2 text-3xl font-bold">USA</h3>
          <h4 className="block text-xl text-[#898fa4] ">+177777347</h4>
          <h4 className="block text-xl text-[#898fa4] ">us@abelling.com</h4>
          <h4 className="block text-xl text-[#898fa4] ">San Francisco, CA,</h4>
          <h4 className="block text-xl text-[#898fa4] ">USA</h4>
        </div>

        <div className=" text-white ">
          <h3 className="my-2 text-3xl font-bold">BANGLADESH</h3>
          <h4 className="block text-xl text-[#898fa4] ">+880121313233</h4>
          <h4 className="block text-xl text-[#898fa4] ">bd@abelling.com</h4>
          <h4 className="block text-xl text-[#898fa4] ">
